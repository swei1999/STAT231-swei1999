...
> ANSWER: idf are weighted less for words that are more likely to appear
...
> ANSWER: it has a rating of +2, although it sometimes may have some negative connotations.

```{r}
afinn_lexicon <- get_sentiments("afinn")
filter(afinn_lexicon, word == "slick")
```
...
> ANSWER: It's essentially the long format for the words
...
> ANSWER: Yes, the poemsn were written long ago so meanings can change and spellings can change.

- The lexicons are based on unigrams.  Do you see any disadvantages of basing the sentiment on single words?

> ANSWER: Yes, sentiments could be expessed in phrases that wouldn't get picked up.
