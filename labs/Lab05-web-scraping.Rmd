...
```{r}
poem_url <- paste0("https://en.wikisource.org/wiki/A_Bee_his_burnished_Carriage")
poem_url
...
all_poems <- data.frame(name = poems_list[1]
                        , text = ""
...
for (i in 1:5){
  ...
  url <- all_poems$Name[i]
  url <- paste0("https://en.wikisource.org/wiki/",url)
