...
Thank you to Mine Cetinkaya-Rundel for this lab.
...
Let's create a visualization that displays how the voting record of the United States changed over time on a variety of issues, and compare it to another country. The other country we'll display is 
Brazil.
