...
> ANSWER: This data graphic is conveying what major(s) Williams College alums graduated with and what career choice they ended up choosing.
...
> ANSWER: Visual cues include: color (refers to majors), length/area (shows how many people are in the majors), direction (major to career choice and vice versa). Coordinate system: polar because coordinates are placed on a radius and angle. Scale: Categorical (the different majors and career choices). 
...
> ANSWER: I thought that this graphic was very interesting and unique. From my understanding, it conveys clearly the relative amount of different majors at Williams College along with what Williams College alums choose as their career path. The only thing I would have considered doing differently would be having more drastic color differences between the majors because the compilation of everything looks a little confusing.
...
> ANSWER: From this graph, it is evident that there is an association between winning percentage and payroll. As such, as winning percentage increases so does payroll.
