...
> ANSWER: 1) Can you set a seed for the data/Is 'caching values' the same as setting a seed? and 2) What are cases when you would want to use observeEvent to run code on the server when you could just run the code in a separate Rmd file?
