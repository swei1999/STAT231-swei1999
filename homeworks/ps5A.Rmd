...
> ANSWER: These two commands differ because the "\\" searches for the literal value of "." In this example, the first command returns the values of the indices in the character vector `macbeth` that contain the phrase "MACBETH.", while the second command returns "MACBETH" followed by any other character.
